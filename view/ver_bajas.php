                            ...
                            <td>
                                <?php if ($tipo == 'ADMINISTRADOR' || $tipo == 'SUPERUSUARIO') : ?>
                                    <?php if ($peticion['PET_ACEPTADO'] != 'SI') : ?>
                                        <div class="d-flex">
                                            <a href="#" class="btn btn-success aceptar-btn mr-1" data-id="<?= $peticion['PET_ID'] ?>">Aceptar</a>
                                            <a href="#" class="btn btn-danger rechazar-btn" data-id="<?= $peticion['PET_ID'] ?>">Rechazar</a>
                                        </div>
                                    <?php else : ?>
                                        <div class="d-flex">
