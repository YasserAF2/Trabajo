...
<div class="container mt-5">
    <h2>Solicitar Baja por Accidente</h2>
    <form action="index.php?action=submit_baja_accidente" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
