...
<div class="container mt-5">
    <h2>Solicitud Licencia por Lactancia/Maternidad/Paternidad</h2>
    <form action="index.php?action=submit_lmp" method="post" enctype="multipart/form-data" class="needs-validation" novalidate>
