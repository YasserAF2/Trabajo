...
<div class="container mt-5">
    <form id="asuntos-form" action="index.php?action=solicitud_asuntos_propios_norm" method="post"
        ...
        <div class="header d-flex justify-content-between align-items-center px-5 ms-xl-4 mb-2" style="height: 100px;">
            ...
            <div class="perfil-titulo">
                <h1>Elegir Días de Asuntos Propios No Remunerados</h1>
            </div>
        </div>
...
document.getElementById('asuntos-form').addEventListener('submit', function(event) {
    ...
    if (selectedDate) {
        ...
        // Usar SweetAlert para mostrar el cuadro de confirmación
        event.preventDefault(); // Prevenir el envío del formulario para mostrar el diálogo
        Swal.fire({
        ...
        Swal.fire({
            title: 'Error',
            text: 'Por favor, selecciona una fecha antes de enviar el formulario.',
            icon: 'error',
