    ...
    <table class="table table-bordered">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <form action="index.php?action=cambiar_tipo" method="post" class="ajax-form"
    ...
    searchForm.addEventListener("submit", e => {
        ...
        fetch(`index.php?action=buscar&buscador=${encodeURIComponent(valorBusqueda)}`)
            .then(response => response
                .text()) // Cambia a .text() temporalmente para ver la respuesta completa
            .then(text => {
                console.log(text); // Imprime la respuesta completa en la consola
            ...
            .then(data => {
                if (data.success) {
                    ...
                    let tablaResultados =
                        '<table class="table table-bordered"><thead><tr><th>DNI</th><th>Nombre Completo</th><th>Tipo</th></tr></thead><tbody>';
                    ...
                    document.querySelectorAll("form.ajax-form").forEach(form => {
                        form.addEventListener("submit", function(event) {
                            event
                                .preventDefault(); // Evita que se envíe el formulario de forma tradicional
